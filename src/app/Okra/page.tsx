      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Learn how to start, scale, and legally grow an Okra business from
            local selling to national distribution and international exports.
          </p>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <ul className="space-y-4 text-lg">
              ...
              <li>
                <strong>Why:</strong> Freshest possible quality and higher
                profit margins.
              </li>

              <li>
                <strong>Investment:</strong> Seeds, irrigation, fertilizers, and
        ...
        <section className="mb-16">
          ...
          <p className="text-lg mb-8">
            As your business grows, the registrations and licenses required also
            increase. Follow the roadmap below.
          </p>
          ...
          <div className="border rounded-2xl p-8">
            ...
            <div className="mt-6 p-4 bg-yellow-50 rounded-lg">
              ...
              frozen bhindi, dehydrated bhindi, or pickled okra instead of raw
              bhindi due to shelf-life limitations.
            </div>
          </div>
        </section>
        <section className="mb-16">
          ...
          <p className="text-lg text-gray-600 mb-8">
            These platforms and tools can help you source products, buy
            equipment, find buyers, and scale your Okra business faster.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="border rounded-2xl p-6 hover:shadow-lg transition">
              ...
              <p className="text-gray-600 mb-4">
                Buy packaging materials, weighing scales, storage crates, vacuum
                sealers, and farming tools.
              </p>
